...
from .fields import IndexedFileField


class IndexedFileUploadMixin:
    """
    Mixin for ModelForms that need to handle file uploads and create IndexedFile entries.
    ...
    Usage:
        class TapeImageForm(IndexedFileUploadMixin, forms.ModelForm):
            ...
            indexed_file_field_name = 'indexed_file'  # The model field to store IndexedFile
...
class MultipleIndexedFilesFormMixin:
    ...
    def save_indexed_files(self, indexed_files):
        ...
        raise NotImplementedError(
            "Subclasses must implement save_indexed_files method"
        )
